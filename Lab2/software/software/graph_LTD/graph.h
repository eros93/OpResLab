...
typedef struct _link
{
  ...
  TRAFFIC flow_aggr;		/* Quantità di traffico totale sul link */
  ...
  CAPACITY capacity;		/* Capacità sul link senza guasti */
  CAPACITY broken_capacity;	/* Capacità sul link massima dovuta a guasti */
...
/* Il Grafo è costituito da 5 campi + un vettore di puntatori alla
 struttura _node */
